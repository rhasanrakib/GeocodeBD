...
--
-- Host: db
-- Generation Time: Jan 25, 2022 at 09:44 AM
...
INSERT INTO `districts` (`id`, `divisionsId`, `name`, `bn_name`, `lat`, `lon`, `url`) VALUES
...
INSERT INTO `unions` (`id`, `upazilasId`, `name`, `bn_name`, `url`) VALUES
...
INSERT INTO `upazilas` (`id`, `districtsId`, `name`, `bn_name`, `url`) VALUES
...
ALTER TABLE `districts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_4ea331805ca708930c374207c24` (`divisionsId`);
...
ALTER TABLE `unions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_2cdc27870553fdd805fb5b03136` (`upazilasId`);
...
ALTER TABLE `upazilas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_589476d572071391361f282ada2` (`districtsId`);
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `FK_4ea331805ca708930c374207c24` FOREIGN KEY (`divisionsId`) REFERENCES `divisions` (`id`);

--
-- Constraints for table `unions`
--
ALTER TABLE `unions`
  ADD CONSTRAINT `FK_2cdc27870553fdd805fb5b03136` FOREIGN KEY (`upazilasId`) REFERENCES `upazilas` (`id`);

--
-- Constraints for table `upazilas`
--
ALTER TABLE `upazilas`
  ADD CONSTRAINT `FK_589476d572071391361f282ada2` FOREIGN KEY (`districtsId`) REFERENCES `districts` (`id`);
COMMIT;
